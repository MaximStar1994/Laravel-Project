...
class ConfigSeeder extends Seeder
{
    ...
    public function run()
    {
        $contact_data = array(
            ...
            array(
                'name' => 'primary_email',
                'value' => 'ProCrowdsourcing@gmail.com',
                'status' => 1,
            ),
            6 =>
            array(
